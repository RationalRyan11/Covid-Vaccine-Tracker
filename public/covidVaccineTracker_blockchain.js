...
const isMetaMaskInstalled = () => {
  ...
  const initialize = () => {
    ...
    let accounts;
    let covidVaccineTrackerABI;
    let covidVaccineTrackeraddress;
    let covidVaccineRegister;
          ...
          outputs: [
            {
              ...
              internalType: "struct covidVaccineRegister.VaccinationRecord",
              name: "",
              type: "tuple"
            }
          ],
    ...
    */ 
    ...
    $(".addUserToBlockchainBtn").click(addvaccineRecordToBlockchain());
    ...
    function handle_error(err) {
      ...
      var message_description = "Covid Vaccine Tracker call failed: " + err;
      if (typeof error_data !== "undefined") {
        var error_message = error_data.message;
        if (typeof error_message !== "undefined") {
          message_description =
            "Covid Vaccine Tracker call failed: " + error_message;
        }
      }
    ...
    async function addvaccineRecordToBlockchain() {
      ...
      console.log("fname to add to blockchain - " + name);
      console.log("lname to add to blockchain - " + surname);
      ...
      try {
        const transaction = await covidVaccineRegister.createVaccinationRecord("Ryan", "Davies", "Test", "Test", "Test");
